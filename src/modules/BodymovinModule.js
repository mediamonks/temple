...
export default class BodymovinModule extends Module {
  constructor(data, banner) {
    ...
    if (data.instances) {
      for (var i in data.instances) {
        data.instances[i].id = i;
        data.instances[i].autoplay = data.instances[i].autoplay != undefined ? data.instances[i].autoplay : true;
        data.instances[i].loop = data.instances[i].loop != undefined ? data.instances[i].loop : false;
        data.instances[i].completeHandler =
          data.instances[i].completeHandler != undefined ? data.instances[i].completeHandler : null;
        this.loadJSON(
          data.instances[i].json,
          data.instances[i].container,
          data.instances[i].autoplay,
          data.instances[i].loop,
          data.instances[i].completeHandler
        );
      }
    } else {
      this.initBodymovinModule();
    }
  }
  ...
  loadJSON(json, container, autoplay, loop, completeHandler) {
    if (!this.instances) {
      this.instances = [];
    }
    ...
    instance.autoplay = autoplay != undefined ? autoplay : false;
    instance.loop = loop != undefined ? loop : false;
    instance.completeHandler = completeHandler;

    this.instances[this.instances.length] = instance;

    loadJSON(instance.json, this.onJSONComplete.bind(this));
  }

  onJSONComplete(jsonData) {
    this.createInstance(jsonData, this.instances[this.loadCount]);

    this.loadCount++;

    if (this.loadCount == this.instances.length && !this.initialized) {
      this.initBodymovinModule();
    }
  }

  createInstance(jsonData, instance) {
    ...
    var animData = {
      ...
      // prerender: false,
      animationData: instance.jsonData,
    };

    instance.animation = bodymovin.loadAnimation(animData);

    if (instance.completeHandler && banner) {
      instance.completeHandler();
    }
  }

  getTotalTime(instance) {
    return instance.animation.totalFrames / instance.animation.frameRate;
  }

  // BodymovinModule.prototype.createContainer = function(id) {
  // 	this.bodymovinContainer = document.createElement('div');
  // 	temple.utils.createStyle('.bodymovinContainer', 'position: absolute;width:100%;height:100%');
  // 	this.bodymovinContainer.classList.add('.bodymovinContainer');
  // 	banner.banner.appendChild(this.bodymovinContainer);

  // 	return this.bodymovinContainer;
  // }
}

/////////////Bodymovin hasn't got a CDN yet so for now I include it here/////////////
...
(function(root, factory) {
  ...
  function HSVtoRGB(t, e, s) {
    var r, i, a, n, o, h, l, p;
    switch ((1 === arguments.length && ((e = t.s), (s = t.v), (t = t.h)),
    (n = Math.floor(6 * t)),
    (o = 6 * t - n),
    (h = s * (1 - e)),
    (l = s * (1 - o * e)),
  ...
  function bezFunction() {
    ...
    function i(t, e) {
      ...
      for (var o = s[i].l > a ? -1 : 1, h = !0; h; )
        s[i].l <= a && s[i + 1].l > a ? ((n = (a - s[i].l) / (s[i + 1].l - s[i].l)), (h = !1)) : (i += o),
          (0 > i || i >= r - 1) && (h = !1);
  ...
  function dataFunctionManager() {
            ...
            for (d = g.length, f = 0; d > f; f += 1)
              if (g[f].pt.k.i) r(g[f].pt.k);
                ...
                for (u = g[f].pt.k.length, c = 0; u > c; c += 1)
                  g[f].pt.k[c].s && r(g[f].pt.k[c].s[0]), g[f].pt.k[c].e && r(g[f].pt.k[c].e[0]);
          }
          0 === h.ty
            ? ((h.layers = e(h.refId, a)), t(h.layers, a, o))
            : 4 === h.ty ? s(h.shapes) : 5 == h.ty && n(h, o);
        }
    }
    function e(t, e) {
    ...
    function i(t, e) {
      ...
      return t[0] > s[0]
        ? !0
        : s[0] > t[0] ? !1 : t[1] > s[1] ? !0 : s[1] > t[1] ? !1 : t[2] > s[2] ? !0 : s[2] > t[2] ? !1 : void 0;
    }
    function a(e, s) {
            ...
            : 'black' === E[s].toLowerCase()
              ...
              : 'medium' === E[s].toLowerCase()
                ...
                : 'regular' === E[s].toLowerCase() || 'normal' === E[s].toLowerCase()
                  ? (k = '400')
                  : ('light' === E[s].toLowerCase() || 'thin' === E[s].toLowerCase()) && (k = '200');
      if (((p.fWeight = k), (p.fStyle = S), (r = p.t.length), p.sz)) {
        var x = p.sz[0],
          M = -1;
        for (s = 0; r > s; s += 1)
          (i = !1),
            ' ' === p.t.charAt(s) ? (M = s) : 13 === p.t.charCodeAt(s) && ((g = 0), (i = !0)),
            e.chars
              ? ((h = e.getCharData(p.t.charAt(s), b.fStyle, b.fFamily)), (P = i ? 0 : h.w * p.s / 100))
              : (P = e.measureText(p.t.charAt(s), p.f, p.s)),
            g + P > x
              ? (-1 === M
                  ? ((p.t = p.t.substr(0, s) + '\r' + p.t.substr(s)), (r += 1))
                  : ((s = M), (p.t = p.t.substr(0, s) + '\r' + p.t.substr(s + 1))),
                (M = -1),
                (g = 0))
              : (g += P);
        r = p.t.length;
      ...
      for (g = 0, P = 0, s = 0; r > s; s += 1)
        if (
          ...
          ' ' === p.t.charAt(s)
            ? (a = 'Â ')
            : 13 === p.t.charCodeAt(s)
              ? (y.push(g), (v = g > v ? g : v), (g = 0), (a = ''), (i = !0), (u += 1))
              : (a = p.t.charAt(s)),
          e.chars
            ? ((h = e.getCharData(p.t.charAt(s), b.fStyle, e.getFontByName(p.f).fFamily)),
              (P = i ? 0 : h.w * p.s / 100))
      ...
      for (n = 0; o > n; n += 1) {
        for (
          C[n].a.sc && (p.strokeColorAnim = !0),
            ...
            (C[n].a.fc || C[n].a.fh || C[n].a.fs || C[n].a.fb) && (p.fillColorAnim = !0),
            w = 0,
            D = C[n].s.b,
            s = 0;
          r > s;
          ...
          (l[s].anIndexes[n] = w),
            ((1 == D && '' != l[s].val) ||
              (2 == D && '' != l[s].val && 'Â ' != l[s].val) ||
              (3 == D && (l[s].n || 'Â ' == l[s].val || s == r - 1)) ||
              (4 == D && (l[s].n || s == r - 1))) &&
        ...
        if (1 === C[n].s.rn)
          for (s = 0; r > s; s += 1)
            I != l[s].anIndexes[n] &&
              ((I = l[s].anIndexes[n]), (F = T.splice(Math.floor(Math.random() * T.length), 1)[0])),
              (l[s].anIndexes[n] = F);
      }
  ...
  function SVGRenderer(t, e) {
    (this.animationItem = t),
      ...
      (this.renderConfig = { preserveAspectRatio: (e && e.preserveAspectRatio) || 'xMidYMid meet' }),
      (this.elements = []),
      (this.destroyed = !1);
  }
  ...
  function MaskElement(t, e, s) {
    ...
    for (r = 0; f > r; r++)
      if (
        ((('a' !== d[r].mode && 'n' !== d[r].mode) || d[r].inv) && ((g = 'mask'), (v = 'mask')),
    ...
    for (this.maskElement = document.createElementNS(svgNS, g), f = u.length, r = 0; f > r; r += 1)
      ...
      return (
        (h.prototype = {
          ...
          _getTForX: function(t) {
            for (
              var e = this._p[0], s = this._p[2], r = this._mSampleValues, i = 0, h = 1, l = u - 1;
              h !== l && r[h] <= t;
              ++h
            )
              i += y;
    ...
    for (var t = 0, e = ['ms', 'moz', 'webkit', 'o'], s = 0; s < e.length && !window.requestAnimationFrame; ++s)
      (window.requestAnimationFrame = window[e[s] + 'RequestAnimationFrame']),
        (window.cancelAnimationFrame =
          window[e[s] + 'CancelAnimationFrame'] || window[e[s] + 'CancelRequestAnimationFrame']);
  ...
  var bez = bezFunction(),
              ...
              : ((s = this.fonts[t].monoCase.node),
                ...
                s.offsetWidth !== r
                  ...
                  : ((s = this.fonts[t].sansCase.node),
                    ...
                    s.offsetWidth !== r && ((a -= 1), (this.fonts[t].loaded = !0))),
                this.fonts[t].loaded &&
    ...
    PropertyFactory = (function() {
          ...
          if (
            ...
            if (e.to) {
              ...
              if (t >= s.t - this.offsetTime || t < e.t - this.offsetTime) {
                ...
                for (l = c.points[u].point.length, o = 0; l > o; o += 1)
                ...
                for (a = 1, n = !0, m = c.points.length; n; ) {
                  if (((v += c.points[d].partialLength * a), 0 === g || 0 === p || d == c.points.length - 1)) {
                    for (l = c.points[d].point.length, o = 0; l > o; o += 1)
                  ...
                  if (g >= v && g < v + c.points[d + 1].partialLength) {
                    for (
                      y = (g - v) / c.points[d + 1].partialLength, l = c.points[d].point.length, o = 0;
                      l > o;
                      o += 1
                    )
                      (this.v[o] = this.mult
                        ? (c.points[d].point[o] + (c.points[d + 1].point[o] - c.points[d].point[o]) * y) * this.mult
                        : c.points[d].point[o] + (c.points[d + 1].point[o] - c.points[d].point[o]) * y),
              ...
              for (i = e.s.length, r = 0; i > r; r += 1) {
                    ...
                    (e.o.x instanceof Array
                      ? ((x = !0),
                        ...
                        e.__fnct[r] ||
                          ...
                          (E = e.i.x[r] || e.i.x[0]),
                          (k = e.i.y[r] || e.i.y[0])))
                      : ((x = !1), e.__fnct || ((b = e.o.x), (P = e.o.y), (E = e.i.x), (k = e.i.y))),
                    x
                      ? e.__fnct[r]
                        ? (f = e.__fnct[r])
                        : ((f = BezierFactory.getBezierEasing(b, P, E, k).get), (e.__fnct[r] = f))
                      : e.__fnct
                        ? (f = e.__fnct)
                        : ((f = BezierFactory.getBezierEasing(b, P, E, k).get), (e.__fnct = f)),
                    (p =
                      t >= s.t - this.offsetTime
                        ? 1
                        : t < e.t - this.offsetTime
                          ? 0
                          : f((t - (e.t - this.offsetTime)) / (s.t - this.offsetTime - (e.t - this.offsetTime))))),
                  this.sh && 1 !== e.h)
                ) {
                  var M = e.s[r],
                    C = e.e[r];
                  -180 > M - C ? (M += 360) : M - C > 180 && (M -= 360), (S = M + (C - M) * p);
                ...
                1 === i
                  ...
                  : ((this.v[r] = this.mult ? S * this.mult : S),
                    (this.pv[r] = S),
                    this.lastPValue[r] !== this.pv[r] && ((this.mdf = !0), (this.lastPValue[r] = this.pv[r])));
              }
            }
          }
      ...
      function s(t, e, s) {
        ...
        var r = Array.apply(null, { length: e.k.length });
        this.vel = r.map(function() {
          return 0;
        });
        var i,
          a = e.k.length;
        for (i = 0; a > i; i += 1) (this.v[i] = s ? e.k[i] * s : e.k[i]), (this.pv[i] = e.k[i]);
      }
      function r(e, s, r) {
        (this.keyframes = s.k),
      ...
      function a(t, a, n, o, h) {
        ...
        if (2 === n) p = new l(t, a, h);
          ...
          if ('number' == typeof a.k[0]) p = new s(t, a, o);
          else
            switch (n) {
              case 0:
                p = new r(t, a, o);
        ...
        l = (function() {
            ...
            this.a && t.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]),
              ...
              this.r
                ...
                : t
                    ...
                    .rotateX(this.or.v[0]),
              this.data.p.s
                ? this.data.p.z ? t.translate(this.px.v, this.py.v, -this.pz.v) : t.translate(this.px.v, this.py.v, 0)
          ...
          return function(d, c, u) {
            (this.elem = d),
              ...
              (this.v = new Matrix()),
              c.p.s
                ? ((this.px = PropertyFactory.getProp(d, c.p.x, 0, 0, this.dynamicProperties)),
                  (this.py = PropertyFactory.getProp(d, c.p.y, 0, 0, this.dynamicProperties)),
                  c.p.z && (this.pz = PropertyFactory.getProp(d, c.p.z, 0, 0, this.dynamicProperties)))
                : (this.p = PropertyFactory.getProp(d, c.p, 1, 0, this.dynamicProperties)),
              c.r
                ? (this.r = PropertyFactory.getProp(d, c.r, 0, degToRads, this.dynamicProperties))
                : c.rx &&
                  ((this.rx = PropertyFactory.getProp(d, c.rx, 0, degToRads, this.dynamicProperties)),
                  (this.ry = PropertyFactory.getProp(d, c.ry, 0, degToRads, this.dynamicProperties)),
                  (this.rz = PropertyFactory.getProp(d, c.rz, 0, degToRads, this.dynamicProperties)),
                  (this.or = PropertyFactory.getProp(d, c.or, 0, degToRads, this.dynamicProperties))),
              c.sk &&
                ((this.sk = PropertyFactory.getProp(d, c.sk, 0, degToRads, this.dynamicProperties)),
                (this.sa = PropertyFactory.getProp(d, c.sa, 0, degToRads, this.dynamicProperties))),
              c.a && (this.a = PropertyFactory.getProp(d, c.a, 1, 0, this.dynamicProperties)),
              c.s && (this.s = PropertyFactory.getProp(d, c.s, 1, 0.01, this.dynamicProperties)),
              (this.o = c.o ? PropertyFactory.getProp(d, c.o, 0, 0.01, u) : { mdf: !1, v: 1 }),
        ...
        m = (function() {
          ...
          function e(t) {
            ...
            if (2 == h) (a = o === n ? (t >= o ? 1 : 0) : s(0, r(0.5 / (o - n) + (t - n) / (o - n), 1))), (a = e(a));
              ...
              (a = o === n ? (t >= o ? 0 : 1) : 1 - s(0, r(0.5 / (o - n) + (t - n) / (o - n), 1))), (a = e(a));
            else if (4 == h)
              o === n
                ? (a = t >= o ? 0 : 1)
                : ((a = s(0, r(0.5 / (o - n) + (t - n) / (o - n), 1))), 0.5 > a ? (a *= 2) : (a = 1 - a));
            else if (5 == h)
              if (o === n) a = t >= o ? 0 : 1;
              else {
                var l = o - n;
              ...
              6 == h
                ? (a = o === n ? (t >= o ? 0 : 1) : (1 + (Math.cos(Math.PI + 2 * Math.PI * (t - n) / (o - n)) + 0)) / 2)
                : t >= i(n) && (a = 0 > t - n ? 1 - (n - t) : s(0, r(o - t, 1)));
            return a * this.a.v;
          }
          var s = Math.max,
            r = Math.min,
          ...
          return (
            ...
            function(s, r, i) {
              (this.mdf = !1),
                ...
                (this.e =
                  'e' in r
                    ? PropertyFactory.getProp(s, r.e, 0, 0, this.dynamicProperties)
      ...
      function t() {
        ...
        if (
          ...
          if (t < this.keyframes[0].t - this.offsetTime) (e = this.keyframes[0].s[0]), (r = !0);
            ...
            for (
              var i, a, o, h, l, p, m = 0, f = this.keyframes.length - 1, d = 1, c = !0;
              c && ((i = this.keyframes[m]), (a = this.keyframes[m + 1]), !(a.t - this.offsetTime > t && 1 == d));
            ...
            if (!r) {
              ...
              i.__fnct
                ? (y = i.__fnct)
                : ((y = BezierFactory.getBezierEasing(i.o.x, i.o.y, i.i.x, i.i.y).get), (i.__fnct = y)),
                (u =
                  t >= a.t - this.offsetTime
                    ? 1
                    : t < i.t - this.offsetTime
                      ? 0
                      : y((t - (i.t - this.offsetTime)) / (a.t - this.offsetTime - (i.t - this.offsetTime)))),
                (s = i.e[0]);
            }
            e = i.s[0];
          }
          ...
          for (o = 0; h > o; o += 1)
            for (l = 0; p > l; l += 1)
              r
                ? ((g = e.i[o][l]),
                  this.v.i[o][l] !== g && ((this.v.i[o][l] = g), (this.pv.i[o][l] = g), (v = !0)),
                  (g = e.o[o][l]),
                  this.v.o[o][l] !== g && ((this.v.o[o][l] = g), (this.pv.o[o][l] = g), (v = !0)),
                  (g = e.v[o][l]),
                  this.v.v[o][l] !== g && ((this.v.v[o][l] = g), (this.pv.v[o][l] = g), (v = !0)))
        ...
        o = (function() {
          ...
          function e(t) {
            var e,
              s = this.dynamicProperties.length;
            if (this.elem.globalData.frameId !== this.frameId) {
              for (this.mdf = !1, this.frameId = this.elem.globalData.frameId, e = 0; s > e; e += 1)
  ...
  (ShapeModifier.prototype.initModifierProperties = function() {}),
    ...
    (TrimModifier.prototype.getSegmentsLength = function(t) {
      ...
      return (
        s && ((o[e] = bez.getBezierLength(r[e], r[0], i[e], a[0])), (h += o[e].addedLength)),
    ...
    (TrimModifier.prototype.processShapes = function() {
      var t,
        ...
        l = this.eValue,
        p = 0;
      if (l === h) for (e = 0; o > e; e += 1) (this.shapes[e].shape.paths = []), (this.shapes[e].shape.mdf = !0);
      else {
        var m,
          f,
          d = [];
        for (e = 0; o > e; e += 1)
          if (((m = this.shapes[e]), m.shape.mdf || this.mdf)) {
            for (t = m.shape.paths, m.shape.mdf = !0, r = t.length, i = [], n = 0, s = 0; r > s; s += 1)
              (a = this.getSegmentsLength(t[s])), i.push(a), (n += a.totalLength);
        ...
        for (e = 0; o > e; e += 1)
          if (((f = []), (m = this.shapes[e]), m.shape.mdf)) {
            (d.length = 0),
              1 >= l
                ? d.push({ s: m.totalShapeLength * h, e: m.totalShapeLength * l })
                : h >= 1
                  ? d.push({ s: m.totalShapeLength * (h - 1), e: m.totalShapeLength * (l - 1) })
    ...
    (TrimModifier.prototype.addShapes = function(t, e, s) {
      ...
      for (s ? (o = s.v.length - 1) : ((s = { c: !1, v: [], i: [], o: [] }), (o = 0)), r = 0; f > r; r += 1) {
        for (h = p[r].lengths, a = m[r].c ? h.length : h.length + 1, i = 1; a > i; i += 1)
          if (((n = h[i - 1]), d + n.addedLength < e.s)) d += n.addedLength;
            ...
            e.s <= d && e.e >= d + n.addedLength
              ? this.addSegment(m[r].v[i - 1], m[r].o[i - 1], m[r].i[i], m[r].v[i], s, o)
              : ((l = bez.getNewSegment(
                  m[r].v[i - 1],
                  m[r].v[i],
                  m[r].o[i - 1],
        ...
        if (m[r].c && d <= e.e) {
          ...
          e.s <= d && e.e >= d + c
            ? this.addSegment(m[r].v[i - 1], m[r].o[i - 1], m[r].i[0], m[r].v[0], s, o)
            : ((l = bez.getNewSegment(
                m[r].v[i - 1],
                m[r].v[0],
                m[r].o[i - 1],
      ...
      if (0 !== a) {
        ...
        for (e = 0; i > e; e += 1)
          if (((n = this.shapes[e]), n.shape.mdf || this.mdf)) {
            for (n.shape.mdf = !0, t = n.shape.paths, r = t.length, s = 0; r > s; s += 1)
    ...
    (SVGRenderer.prototype.buildItems = function(t, e, s, r, i) {
      ...
      for (a = n - 1; a >= 0; a--)
        (s[a] = this.createItem(t[a], e, r, i)),
          0 === t[a].ty &&
            ((o = []),
            this.buildItems(t[a].layers, s[a].getDomElement(), o, s[a], s[a].placeholder),
            s[a].setElements(o)),
        ...
        for (a = 0; h > a; ) {
          if (s[a].data.id == t[r].id) {
            (o = s[a]),
              ...
              0 === t[r].ty &&
                ((n = []),
                this.buildItems(t[r].layers, s[a].getDomElement(), n, s[a], s[r].placeholder),
                s[a].setElements(n));
            break;
          }
          a += 1;
    ...
    (SVGRenderer.prototype.buildItemParenting = function(t, e, s, r, i, a) {
      ...
      for (var n = 0, o = s.length; o > n; )
        s[n].ind == r &&
          (e.getHierarchy().push(i[n]), void 0 !== s[n].parent && this.buildItemParenting(t, e, s, s[n].parent, i, !1)),
          (n += 1);
    }),
    ...
    (CanvasRenderer.prototype.buildItemHierarchy = function(t, e, s, r, i, a) {
      ...
      for (a && e.resetHierarchy(); o > n; )
        s[n].ind === r &&
          (e.getHierarchy().push(i[n]), void 0 !== s[n].parent && this.buildItemHierarchy(t, e, s, s[n].parent, i, !1)),
          (n += 1);
    }),
    ...
    (HybridRenderer.prototype.buildItems = function(t, e, s, r, i) {
      ...
      for (a = n - 1; a >= 0; a--)
        e
          ? (s[a] = this.createItem(t[a], e, r, i))
          : t[a].ddd
            ? (l || ((l = !0), (o = this.getThreeDContainer())), (s[a] = this.createItem(t[a], o, r, i)))
            : ((l = !1), (s[a] = this.createItem(t[a], this.animationItem.resizerElem, r, i))),
          0 === t[a].ty &&
            ((h = []),
            this.buildItems(t[a].layers, s[a].getDomElement(), h, s[a], s[a].placeholder),
            s[a].setElements(h)),
          t[a].td && s[a + 1].setMatte(s[a].layerId);
      if (((this.currentContainer = this.animationItem.resizerElem), !e && this.threeDElements.length))
        if (this.camera) this.camera.setup();
          ...
          for (n = this.threeDElements.length, a = 0; n > a; a += 1)
            this.threeDElements[0][a].style.perspective = this.threeDElements[0][a].style.webkitPerspective =
    ...
    (HybridRenderer.prototype.buildItemParenting = function(t, e, s, r, i, a) {
      ...
      for (var n = 0, o = s.length; o > n; )
        s[n].ind == r &&
          ...
          void 0 !== s[n].parent && this.buildItemParenting(t, e, s, s[n].parent, i, !1)),
          (n += 1);
    }),
    ...
    (HybridRenderer.prototype.updateContainerSize = function() {
      ...
      o > n
        ...
        : ((t = a / this.globalData.compSize.h),
          ...
          (r = 0)),
        (this.animationItem.resizerElem.style.transform = this.animationItem.resizerElem.style.webkitTransform =
          'matrix3d(' + t + ',0,0,0,0,' + e + ',0,0,0,0,1,0,' + s + ',' + r + ',0,1)');
    }),
        ...
        if (
          ...
          this.storedData[t].x.v < 0
            ...
            : ('dilate' !== this.storedData[t].lastOperator &&
                ((this.storedData[t].lastOperator = 'dilate'), this.storedData[t].elem.setAttribute('filter', null)),
    ...
    (MaskElement.prototype.drawPath = function(t, e, s) {
      ...
      t.cl &&
        (a +=
          ...
          bm_rnd(e.v[0][1])),
        s.lastPath !== a &&
          (t.inv ? s.elem.setAttribute('d', this.solidPath + a) : s.elem.setAttribute('d', a), (s.lastPath = a));
    }),
    ...
    (BaseElement.prototype.prepareFrame = function(t) {
      this.data.ip - this.data.st <= t && this.data.op - this.data.st > t
        ...
        : this.isVisible !== !1 && ((this.globalData.mdf = !0), (this.isVisible = !1));
      var e,
        s = this.dynamicProperties.length;
      for (e = 0; s > e; e += 1)
        this.dynamicProperties[e].getValue(), this.dynamicProperties[e].mdf && (this.globalData.mdf = !0);
      return (
    ...
    (SVGBaseElement.prototype.renderFrame = function(t) {
      ...
      return (
        ...
        this.data.hasMask
          ? (this.finalTransform.matMdf && this.layerElement.setAttribute('transform', s.to2dCSS()),
            this.finalTransform.opMdf && this.layerElement.setAttribute('opacity', this.finalTransform.opacity))
          : 0 === this.data.ty &&
            this.finalTransform.opMdf &&
            (this.finalTransform.op.k || 1 !== this.finalTransform.op.p) &&
            (this.layerElement.setAttribute('opacity', this.finalTransform.opacity), (this.finalTransform.opacity = 1)),
        this.isVisible
      );
    }),
      ...
      if (e.a.length) {
        ...
        for (s = 0; a > s; s += 1)
          (i = e.a[s]),
            ...
            's' in i.a && (r.a.s = PropertyFactory.getProp(this, i.a.s, 1, 0.01, this.dynamicProperties)),
            'a' in i.a && (r.a.a = PropertyFactory.getProp(this, i.a.a, 1, 0, this.dynamicProperties)),
            'o' in i.a && (r.a.o = PropertyFactory.getProp(this, i.a.o, 0, 0.01, this.dynamicProperties)),
            ...
            'fs' in i.a && (r.a.fs = PropertyFactory.getProp(this, i.a.fs, 0, 0.01, this.dynamicProperties)),
            'fb' in i.a && (r.a.fb = PropertyFactory.getProp(this, i.a.fb, 0, 0.01, this.dynamicProperties)),
      ...
      if (this.maskPath) {
        ...
        if (0 > g && l.closed)
          for (
            ...
            (g += y[b].partialLength), (b -= 1), 0 > b && ((v -= 1), (y = k[v].bezierData.points), (b = y.length - 1));
        ...
        if ((i.reset(), (z = 1), h[s].n))
          ...
          for (st += h[s].l / 2, w = 0; T > w; w += 1)
            (C = V.a[w].a),
              't' in C &&
                ((D = V.a[w].s),
                (B = D.getMult(h[s].anIndexes[w], n.t.a[w].s.totalChars)),
                this.maskPath ? (g += B.length ? C.t * B[0] : C.t * B) : (t += B.length ? C.t.v * B[0] : C.t.v * B));
          for (
            st += h[s].l / 2,
            ...
            (C = V.a[w].a),
              'a' in C &&
                ...
                (B = D.getMult(h[s].anIndexes[w], n.t.a[w].s.totalChars)),
                B.length
                  ? i.translate(-C.a.v[0] * B[0], -C.a.v[1] * B[1], C.a.v[2] * B[2])
          ...
          for (w = 0; T > w; w += 1)
            (C = V.a[w].a),
              's' in C &&
                ...
                (B = D.getMult(h[s].anIndexes[w], n.t.a[w].s.totalChars)),
                B.length
                  ? i.scale(1 + (C.s.v[0] - 1) * B[0], 1 + (C.s.v[1] - 1) * B[1], 1)
          ...
          for (w = 0; T > w; w += 1) {
            if (
              ...
              (B = D.getMult(h[s].anIndexes[w], n.t.a[w].s.totalChars)),
              'sk' in C &&
                (B.length ? i.skewFromAxis(-C.sk.v * B[0], C.sa.v * B[1]) : i.skewFromAxis(-C.sk.v * B, C.sa.v * B)),
              ...
              'o' in C && (z += B.length ? (C.o.v * B[0] - z) * B[0] : (C.o.v * B - z) * B),
              o.strokeWidthAnim && 'sw' in C && (j += B.length ? C.sw.v * B[0] : C.sw.v * B),
              o.strokeColorAnim && 'sc' in C)
            )
              for (W = 0; 3 > W; W += 1)
                O[W] = Math.round(
                  B.length ? 255 * (O[W] + (C.sc.v[W] - O[W]) * B[0]) : 255 * (O[W] + (C.sc.v[W] - O[W]) * B)
                );
            if (o.fillColorAnim) {
              if ('fc' in C)
                for (W = 0; 3 > W; W += 1)
                  G[W] = B.length ? G[W] + (C.fc.v[W] - G[W]) * B[0] : G[W] + (C.fc.v[W] - G[W]) * B;
              'fh' in C && (G = B.length ? addHueToRGB(G, C.fh.v * B[0]) : addHueToRGB(G, C.fh.v * B)),
                'fs' in C && (G = B.length ? addSaturationToRGB(G, C.fs.v * B[0]) : addSaturationToRGB(G, C.fs.v * B)),
                'fb' in C && (G = B.length ? addBrightnessToRGB(G, C.fb.v * B[0]) : addBrightnessToRGB(G, C.fb.v * B));
            }
          }
          for (w = 0; T > w; w += 1)
            (C = V.a[w].a),
              'p' in C &&
                ...
                this.maskPath
                  ...
                  : B.length
                    ? i.translate(C.p.v[0] * B[0], C.p.v[1] * B[1], -C.p.v[2] * B[2])
                    : i.translate(C.p.v[0] * B, C.p.v[1] * B, -C.p.v[2] * B));
          if (
            (o.strokeWidthAnim && (q = 0 > j ? 0 : j),
            o.strokeColorAnim &&
              (X = 'rgb(' + Math.round(255 * O[0]) + ',' + Math.round(255 * O[1]) + ',' + Math.round(255 * O[2]) + ')'),
            o.fillColorAnim &&
              (Y = 'rgb(' + Math.round(255 * G[0]) + ',' + Math.round(255 * G[1]) + ',' + Math.round(255 * G[2]) + ')'),
            this.maskPath)
          ) {
            if (n.t.p.p) {
          ...
          'html' === a
            ...
            !N || (N.o === U && N.sw === q && N.sc === X && N.fc === Y)
              ? ('svg' !== a && 'html' !== a) || (N && N.m === Z)
                ? 'canvas' !== a ||
                  (N &&
                    N.props[0] === J[0] &&
                    N.props[1] === J[1] &&
                    ...
                    N.props[13] === J[13])
                  ? (F = N)
                  : ((this.lettersChangedFlag = !0), (F = new LetterProps(U, q, X, Y, null, J)))
                : ((this.lettersChangedFlag = !0), (F = new LetterProps(U, q, X, Y, Z)))
              : ((this.lettersChangedFlag = !0), (F = new LetterProps(U, q, X, Y, Z, J))),
      ...
      if ((a = n.length)) {
        ...
        for (i = 0; a > i; i += 1) {
          if (
            ...
            m && n[i].n && ((f = 0), (d += t.yOffset), (d += y ? 1 : 0), (y = !1)),
            l.reset(),
          ...
          if (this.globalData.fontManager.chars) {
            ...
            (g = v ? v.data : null),
              g &&
                g.shapes &&
                ((h = g.shapes[0].it), m || (p = ''), (p += this.createPathShape(l, h)), m || o.setAttribute('d', p)),
    ...
    (SVGTextElement.prototype.renderFrame = function(t) {
      ...
      if (
        (this.hidden && ((this.hidden = !1), (this.innerElem.style.display = 'block')),
        this.data.hasMask ||
          (this.finalTransform.matMdf && this.innerElem.setAttribute('transform', this.finalTransform.mat.to2dCSS()),
  ...
  (PlaceHolderElement.prototype.prepareFrame = function() {}),
    ...
    (IImageElement.prototype.renderFrame = function(t) {
      ...
      return e === !1
        ? void this.hide()
        : (this.hidden && ((this.hidden = !1), this.innerElem.setAttribute('visibility', 'visible')),
          this.data.hasMask ||
    ...
    (IShapeElement.prototype.transformHelper = { opacity: 1, mat: new Matrix(), matMdf: !1, opMdf: !1 }),
        ...
        if ('fl' == t[r].ty || 'st' == t[r].ty) {
          ...
          if (
            ...
            if (
              ...
              l.setAttribute('stroke-linecap', this.lcEnum[t[r].lc] || 'round'),
              l.setAttribute('stroke-linejoin', this.ljEnum[t[r].lj] || 'round'),
              l.setAttribute('fill-opacity', '0'),
              1 == t[r].lj && l.setAttribute('stroke-miterlimit', t[r].ml),
              e[r].c.k || l.setAttribute('stroke', 'rgb(' + e[r].c.v[0] + ',' + e[r].c.v[1] + ',' + e[r].c.v[2] + ')'),
              e[r].o.k || l.setAttribute('stroke-opacity', e[r].o.v),
              (e[r].w = PropertyFactory.getProp(this, t[r].w, 0, null, s)),
              e[r].w.k || l.setAttribute('stroke-width', e[r].w.v),
              t[r].d)
            ) {
              var p = PropertyFactory.getDashProp(this, t[r].d, 'svg', s);
              p.k ||
                (l.setAttribute('stroke-dasharray', p.dasharray), l.setAttribute('stroke-dashoffset', p.dashoffset)),
                (e[r].d = p);
            }
          } else
          ...
          t[r].ln && l.setAttribute('id', t[r].ln),
            ...
            this.stylesList.push({ pathElement: l, type: t[r].ty, d: '', ld: '', mdf: !1 }),
          ...
          for (i = 0; a > i; i += 1)
            this.stylesList[i].closed ||
              ('st' === this.stylesList[i].type
                ? ((d = !0),
                  (f = document.createElementNS(svgNS, 'path')),
                  this.stylesList[i].pathElement.appendChild(f),
                  e[r].elements.push({ ty: this.stylesList[i].type, el: f }))
      ...
      if (!this.hidden) {
        ...
        for (t = e - 1; t >= 0; t -= 1)
          '0' !== this.stylesList[t].ld &&
            ...
            this.stylesList[t].pathElement.parentNode &&
              (this.stylesList[t].parent = this.stylesList[t].pathElement.parentNode));
        this.hidden = !0;
      }
    }),
          ...
          'sh' == e[i].ty || 'el' == e[i].ty || 'rc' == e[i].ty || 'sr' == e[i].ty
            ...
            : 'fl' == e[i].ty
              ...
              : 'st' == e[i].ty
                ...
                : 'gr' == e[i].ty ? this.renderShape(n, e[i].it, s[i].it) : 'tm' == e[i].ty;
      if (r) {
        for (a = this.stylesList.length, i = 0; a > i; i += 1)
          '0' === this.stylesList[i].ld &&
            ((this.stylesList[i].ld = '1'), (this.stylesList[i].pathElement.style.display = 'block')),
            'fl' === this.stylesList[i].type &&
    ...
    (IShapeElement.prototype.renderPath = function(t, e, s) {
        ...
        for (n = l.length, a = 0; n > a; a += 1) {
          ...
          if (p && p.v) {
            for (r = p.v.length, i = 1; r > i; i += 1)
              1 == i && (o += ' M' + s.mat.applyToPointStringified(p.v[0][0], p.v[0][1])),
                (o +=
                  ' C' +
      ...
      for (r = e.elements.length, i = 0; r > i; i += 1)
        'st' === e.elements[i].ty
          ? (s.matMdf || e.sh.mdf || this.firstFrame) && e.elements[i].el.setAttribute('d', o)
          : ((e.elements[i].st.mdf = h ? !0 : e.elements[i].st.mdf), (e.elements[i].st.d += o));
    }),
    (IShapeElement.prototype.renderFill = function(t, e, s) {
      var r = e.style;
      (e.c.mdf || this.firstFrame) &&
        r.pathElement.setAttribute(
          'fill',
    ...
    (IShapeElement.prototype.renderStroke = function(t, e, s) {
      ...
      i &&
        ...
        (r.pathElement.setAttribute('stroke-dasharray', i.dasharray),
        r.pathElement.setAttribute('stroke-dashoffset', i.dashoffset)),
        (e.c.mdf || this.firstFrame) &&
          r.pathElement.setAttribute(
            'stroke',
            'rgb(' + bm_floor(e.c.v[0]) + ',' + bm_floor(e.c.v[1]) + ',' + bm_floor(e.c.v[2]) + ')'
    ...
    (CVBaseElement.prototype.renderFrame = function(t) {
      ...
      return (
        t &&
          ...
          (this.finalTransform.matMdf = t.matMdf ? !0 : this.finalTransform.matMdf)),
        this.data.hasMask &&
          (this.globalData.renderer.save(!0), this.maskManager.renderFrame(0 === this.data.ty ? null : s)),
      ...
      for (r = o; r >= 0; r -= 1)
        if ('fl' == t[r].ty || 'st' == t[r].ty) {
          if (
            ...
            (e[r].c = PropertyFactory.getProp(this, t[r].c, 1, 255, s)),
            e[r].c.k ||
              (n.co = 'rgb(' + bm_floor(e[r].c.v[0]) + ',' + bm_floor(e[r].c.v[1]) + ',' + bm_floor(e[r].c.v[2]) + ')'),
            (e[r].o = PropertyFactory.getProp(this, t[r].o, 0, 0.01, s)),
            'st' == t[r].ty &&
          ...
          for (i = 0; a > i; i += 1)
            this.stylesList[i].closed ||
              (this.stylesList[i].elements.push(e[r]), 'st' === this.stylesList[i].type ? (f = !0) : (d = !0));
          (e[r].st = f), (e[r].fl = d);
        } else if ('tm' == t[r].ty || 'rd' == t[r].ty) {
    ...
    (CVShapeElement.prototype.renderPath = function(t, e, s) {
      ...
      if (o) {
        ...
        for (l.length = 0, a = 0; n > a; a += 1) {
          ...
          if (p && p.v) {
            for (r = p.v.length, i = 1; r > i; i += 1)
              1 == i && l.push({ t: 'm', p: s.mat.applyToPointArray(p.v[0][0], p.v[0][1], 0) }),
                l.push({
                  t: 'c',
            ...
            1 == r && l.push({ t: 'm', p: s.mat.applyToPointArray(p.v[0][0], p.v[0][1], 0) }),
              p.c &&
                (l.push({
                  t: 'c',
                  p1: s.mat.applyToPointArray(p.o[i - 1][0], p.o[i - 1][1], 0),
    ...
    (CVTextElement.prototype.createElements = function() {
      ...
      for (r = 0; i > r; r += 1) {
        ...
        if (
          ((l = h ? h.data : null),
          o.reset(),
          v && n[r].n && ((b = 0), (P += t.yOffset), (P += S ? 1 : 0), (S = !1)),
          l && l.shapes)
        ) {
          ...
          for (y = new Array(c), d = 0; c > d; d += 1) {
            for (m = f[d].ks.k.i.length, u = f[d].ks.k, g = [], p = 1; m > p; p += 1)
            ...
            if (
              ...
              for (
                m && m.fc
                  ...
                  : c !== this.values.fill && ((c = this.values.fill), (e.fillStyle = this.values.fill)),
                ...
                for (d = f[a], h = d.length, this.globalData.canvasContext.moveTo(d[0], d[1]), o = 2; h > o; o += 6)
    ...
    (HBaseElement.prototype.renderFrame = function(t) {
      ...
      return (
        t &&
          ...
          (this.finalTransform.matMdf = t.matMdf ? !0 : this.finalTransform.matMdf)),
        this.finalTransform.matMdf &&
          (this.layerElement.style.transform = this.layerElement.style.webkitTransform = s.toCSS()),
  ...
  extendPrototype(IShapeElement, HShapeElement),
    ...
    (HShapeElement.prototype.createElements = function() {
      ...
      if (
        ...
        (e.style.transform = e.style.webkitTransform =
          'translate(' + this.data.bounds.l + 'px,' + this.data.bounds.t + 'px)'),
        this.data.hasMask)
      ) {
    ...
    (HTextElement.prototype.createElements = function() {
      ...
      if (!this.globalData.fontManager.chars)
        if (((this.innerElem.style.fontSize = t.s + 'px'), (this.innerElem.style.lineHeight = t.s + 'px'), i.fClass))
      ...
      if ((this.getMeasures(), this.lettersChangedFlag)) {
        ...
        for (s = 0; r > s; s += 1)
          a[s].n ||
            ...
            this.isMasked
              ? this.textSpans[s].setAttribute('transform', n.m)
              : (this.textSpans[s].style.transform = this.textSpans[s].style.webkitTransform = n.m),
            ...
            n.fc && (this.textPaths[s].setAttribute('fill', n.fc), (this.textPaths[s].style.color = n.fc)));
        if (this.isMasked) {
    ...
    (HImageElement.prototype.createElements = function() {
      ...
      } else styleDiv(s), (this.layerElement = s), this.appendNodeToParent(s), (this.innerElem = s);
    ...
    (HCameraElement.prototype.setup = function() {
      ...
      for (t = 0; s > t; t += 1)
        (e = this.comp.threeDElements[t]),
          ...
          (e[1].style.transformOrigin = e[1].style.mozTransformOrigin = e[1].style.webkitTransformOrigin =
            '0px 0px 0px'),
    ...
    (HCameraElement.prototype.renderFrame = function() {
      ...
      if (
        ...
        var p;
        for (t = 0; e > t; t += 1)
          (p = this.comp.threeDElements[t]), (p[1].style.transform = p[1].style.webkitTransform = this.mat.toCSS());
      }
      this.firstFrame = !1;
    }),
  ...
  var animationManager = (function() {
      function t(e) {
        ...
        for (r.removeEventListener('destroy', t); E > s; )
          v[s].animation === r && (v.splice(s, 1), (s -= 1), (E -= 1)), (s += 1);
      }
      function e(e, s) {
        if (!e) return null;
        for (var r = 0; E > r; ) {
  ...
  (AnimationItem.prototype.setParams = function(t) {
    ...
    (AnimationItem.prototype.setData = function(t, e) {
          ...
          : r.getNamedItem('data-bm-type')
            ...
            : r.getNamedItem('bm-type')
              ...
              : r.getNamedItem('data-bm-renderer')
                ...
                : r.getNamedItem('bm-renderer') ? r.getNamedItem('bm-renderer').value : 'canvas');
      ...
      var a = r.getNamedItem('data-anim-autoplay')
        ...
        : r.getNamedItem('data-bm-autoplay')
          ...
          : r.getNamedItem('bm-autoplay') ? r.getNamedItem('bm-autoplay').value : !0;
      (s.autoplay = 'false' !== a),
      ...
      var n = r.getNamedItem('data-anim-prerender')
        ...
        : r.getNamedItem('data-bm-prerender')
          ...
          : r.getNamedItem('bm-prerender') ? r.getNamedItem('bm-prerender').value : '';
    ...
    (AnimationItem.prototype.togglePause = function(t) {
      (t && this.name != t) ||
        (this.isPaused === !0 ? ((this.isPaused = !1), this.play()) : ((this.isPaused = !0), this.pause()));
    }),
    (AnimationItem.prototype.stop = function(t) {
      (t && this.name != t) ||
        ((this.isPaused = !0), (this.currentFrame = this.currentRawFrame = 0), (this.playCount = 0), this.gotoFrame());
    }),
    ...
    function t(e) {
      ...
      for (s = 0; r > s; s += 1)
        e[s].layerInterface ||
          ...
          e[s].data.hasMask && e[s].layerInterface.registerMaskInterface(e[s].maskManager),
          0 === e[s].data.ty
            ? (e[s].compInterface = CompExpressionInterface(e[s]))
            : 4 === e[s].data.ty &&
              (e[s].layerInterface.shapeInterface = ShapeExpressionInterface.createShapeInterface(
                e[s].shapesData,
                e[s].viewData,
                e[s].layerInterface
              ))),
      ...
      function e(t) {
        ...
        if (e.to) {
          ...
          if (t >= s.t - o || t < e.t - o) {
            ...
            e.__fnct
              ? (d = e.__fnct)
              : ((d = BezierFactory.getBezierEasing(e.o.x, e.o.y, e.i.x, e.i.y, e.n).get), (e.__fnct = d)),
            ...
            for (a = 1, n = !0, f = u.points.length; n; ) {
              ...
              if (v >= b && v < b + u.points[c + 1].partialLength) {
                for (g = (v - b) / u.points[c + 1].partialLength, p = u.points[c].point.length, l = 0; p > l; l += 1)
                ...
                (e.o.x instanceof Array
                  ? ((M = !0),
                    ...
                    e.__fnct[r] ||
                      ...
                      (k = e.i.x[r] || e.i.x[0]),
                      (S = e.i.y[r] || e.i.y[0])))
                  : ((M = !1), e.__fnct || ((P = e.o.x), (E = e.o.y), (k = e.i.x), (S = e.i.y))),
                M
                  ? e.__fnct[r]
                    ? (d = e.__fnct[r])
                    : ((d = BezierFactory.getBezierEasing(P, E, k, S).get), (e.__fnct[r] = d))
                  : e.__fnct ? (d = e.__fnct) : ((d = BezierFactory.getBezierEasing(P, E, k, S).get), (e.__fnct = d)),
                (m = t >= s.t - o ? 1 : t < e.t - o ? 0 : d((t - (e.t - o)) / (s.t - o - (e.t - o))))),
              this.sh && 1 !== e.h)
            ) {
              var C = e.s[r],
                D = e.e[r];
              -180 > C - D ? (C += 360) : C - D > 180 && (C -= 360), (x = C + (D - C) * m);
      ...
      function sum(t, e) {
        ...
        if ('object' === s && 'object' === r) {
          for (var i = 0, a = t.length, n = e.length, o = []; a > i || n > i; )
            (o[i] = 'number' == typeof t[i] && 'number' == typeof e[i] ? t[i] + e[i] : t[i] || e[i]), (i += 1);
          return o;
        }
        return 0;
      }
      ...
      function hslToRgb(t) {
        function e(t, e, s) {
          return (
            0 > s && (s += 1),
            s > 1 && (s -= 1),
            1 / 6 > s ? t + 6 * (e - t) * s : 0.5 > s ? e : 2 / 3 > s ? t + (e - t) * (2 / 3 - s) * 6 : t
          );
        }
        var s,
          r,
            ...
            : 'fl' == t[r].ty
              ...
              : 'st' == t[r].ty
                ...
                : 'tm' == t[r].ty
                  ...
                  : 'tr' == t[r].ty
                    ? i.push(ShapeExpressionInterface.createTransformInterface(t[r], e[r], s))
                    : 'el' == t[r].ty
                      ...
                      : 'sr' == t[r].ty
                        ...
                        : 'sh' == t[r].ty && i.push(ShapeExpressionInterface.createPathInterface(t[r], e[r], s));
        return i;
      }
      var p = {
          ...
          return function(t, e, s) {
                ...
                : t.o.ix === e
                  ...
                  : t.p.ix === e
                    ...
                    : t.r.ix === e
                      ...
                      : t.s.ix === e
                        ? i.scale
                        : t.sk && t.sk.ix === e ? i.skew : t.sa && t.sa.ix === e ? i.skewAxis : void 0;
            }
            e.transform.mProps.o.setGroupProperty(r),
              ...
              e.transform.mProps.sk &&
                (e.transform.mProps.sk.setGroupProperty(r), e.transform.mProps.sa.setGroupProperty(r)),
                    ...
                    : t.or.ix === e || 'ADBE Vector Star Outer Radius' === e
                      ...
                      : t.os.ix === e
                        ...
                        : !t.ir || (t.ir.ix !== e && 'ADBE Vector Star Inner Radius' !== e)
                          ? t.is && t.is.ix === e ? i.innerRoundness : void 0
                          : i.innerRadius;
            }
            var a = 'tm' === e.sh.ty ? e.sh.prop : e.sh;
            return (
